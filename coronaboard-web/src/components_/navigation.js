...
export function Navigation() {
    ...
    const onScroll = () => {
        if(
            window.scrollY > 0 &&
            navBarWrapper.current.getBoundingClientReact().top <= 0
        ) {
            setFixedTop(true);
        } else {
            setFixedTop(false);
                ...
                >
                    <a href="#top" onClick={() => animateScroll.scrollToTop()}>
                        <svg
                            ...
                            viewBox="0 0 16 16"
                        >
                            <path d="M7.646 4.646a.5.5 0 0 1 .708 016 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                        </svg>
                    </a>
                </div>
            ) : null}
